...
export const initializePaymentsRoutes = async (app : Elysia) => {
    ...
    app.post('/buyNewImage/:id', async (context: { body: any; headers: any; params: any }) => {
